    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="jumbotron ">
               ...
               <%if(Session["userName"] == null) { %> <asp:Button ID="registerBtn" CssClass="btn btn-primary" runat="server" Text="Register Now >>" OnClick="registerBtn_Click" /><%} %>
            </div>
